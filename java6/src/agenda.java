...
public class agenda {
    ...
    public static void main(String[] arguments) {
        ...
        do {
            ...
            printConsole("1-Afisarea persoane / 2-Adaugare persoana / 3-Cautare nume / 4-Modificare nume / 5-Stergere nume");
            ...
            if (opt == 1)
                ...
                String telefon = readStringConsole("Introduceti numarul dorit:");
                creare(nume, telefon);
            }
            else if (opt == 3){
